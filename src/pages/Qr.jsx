  ...
  return (
    <div className={styles.main_body_wrap}>
      ...
      <img
        ...
        src="https://i.ibb.co/ZzHHs5Xx/gggggaag.png"
        alt=""
      />
        ...
        <div className={styles.modal_overlay}>
          <div className={styles.modal_box}>
            ...
            <div className={styles.modal_btns}>
              <button className={styles.modal_cancel} onClick={handleCancel}>
                취소
              </button>
              <button className={styles.modal_confirm} onClick={handleConfirm}>
                확인
              </button>
            </div>
          </div>
